...
public class RpcNettyClientSync {
     ...
     */
    public RpcfxResponse getResponse(RpcfxRequest rpcfxRequest, String url) throws InterruptedException,
            URISyntaxException {
        RpcProtocol request = convertNettyRequest(rpcfxRequest);
     ...
     * @param rpcfxRequest RpcRequest
     * @return RpcProtocol
     */
    private RpcProtocol convertNettyRequest(RpcfxRequest rpcfxRequest) {
